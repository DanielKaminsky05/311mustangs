...
- Call `gemma4:26b` via `inference.local` to extract new facts and decide
  whether to submit or ask a follow-up
...
export INFERENCE_BASE_URL=http://inference.local        # NemoClaw default
...
`http://gx10-4a58.local:9000/messages`.
...
$env:INFERENCE_BASE_URL = "http://gx10-4a58.local:11434"
